 ...
 * function has to be implemented by the concrete naive_bayes class.
 *
...
public abstract class Classifier<T, K> implements IFeatureProbability<T, K>, Serializable {
    ...
    /**
     * The naive_bayes's memory. It will forget old classifications as soon as
     * they become too old.
     */
    private Queue<Classification<T, K>> memoryQueue;

    /**
     * Constructs a new naive_bayes without any trained knowledge.
     */
    public Classifier() {
        this.reset();
    }
    ...
    /**
     * Returns a <code>Set</code> of features the naive_bayes knows about.
     *
     * @return The <code>Set</code> of features the naive_bayes knows about.
     */
    ...
    /**
     * Returns a <code>Set</code> of categories the naive_bayes knows about.
     *
     * @return The <code>Set</code> of categories the naive_bayes knows about.
     */
    ...
    /**
     * Retrieves the total number of categories the naive_bayes knows about.
     *
     ...
     * equal to telling the naive_bayes, that this feature has occurred in this
     * category.
     *
     * @param feature
     ...
     * naive_bayes, that this category has occurred once more.
     *
     * @param category
     ...
     * equal to telling the naive_bayes that this feature was classified once in
     * the category.
     *
     * @param feature
     ...
     * naive_bayes, that this category has occurred once less.
     *
     * @param category
     *            The category, which count to increase.
     */
    ...
    /**
     * Train the naive_bayes by telling it that the given features resulted in
     * the given category.
     *
     * @param category
     ...
     * features given and depends on the concrete naive_bayes implementation.
     *
     * @param features
